...
<form action="loginprocess.php" method="post" enctype="multipart/form-data" name="frm_login">
	<table width="339" border="0" align="left">
  <tr>
    <td width="137"><div align="right"><span class="style1">Username</span></div></td>
  ...
  <tr>
    <td><div align="right"><span class="style1">Iris Image</span></div></td>
    <td><input type="file" name="iris"></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td><div class="style2"><b>      
    </b></div></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>
	<!--img src="images_login/login_21.gif" name="btn6" width="55" height="25" id="btn6" onClick="document.frm_login.submit();return false;" onMouseOver="btn6.src='images_login/login1_21.gif'" onMouseOut="btn6.src='images_login/login_21.gif'"-->
