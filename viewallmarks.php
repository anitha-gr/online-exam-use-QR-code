...
<?php
include("db.php");
$rs=mysql_query("select username,perc,examdate,subject from marks") or die(mysql_error());
if(mysql_num_rows($rs)>0) {
echo "<br><table border='1' align='center'><tr><th colspan='4'>EXAM MARKS</th></tr>";
echo "<tr><th>User Name</th><th>Percentage Obtained</th><th>Exam Date</th><th>Subject</th></tr>";
while($r=mysql_fetch_row($rs)) {
echo "<tr><td>$r[0]</td><td>$r[1]%</td><td>$r[2]</td><td>$r[3]</td></tr>";
}
echo "</table>";
} else {
echo "<h3 align='center'>No records to Display... </h3>";
}
?>
</td>
		<td>
